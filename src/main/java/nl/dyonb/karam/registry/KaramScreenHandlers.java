...
public class KaramScreenHandlers {
    ...
    public static final ScreenHandlerType<RgbifierScreenHandler> RGBIFIER_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(Karam.identifier("rgbifier"), RgbifierScreenHandler::new);
